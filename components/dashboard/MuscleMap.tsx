...
export function MuscleMap({ trainedMuscles, gender }: MuscleMapProps) {
  ...
  return (
    ...
    >
      ...
      {/* DETAIL LINES */}
      <line x1="100" y1={male ? 100 : 110} x2="100" y2={male ? 182 : 206} stroke={DETAIL} strokeWidth="1.5" opacity="0.55" />
      <line x1="100" y1={male ? 216 : 238} x2="100" y2={male ? 280 : 296} stroke={DETAIL} strokeWidth="1.5" opacity="0.45" />

      <path d={male ? 'M 88,97 C 78,93 66,91 58,98' : 'M 91,97 C 81,93 69,91 61,98'} stroke={DETAIL} strokeWidth="1.8" fill="none" opacity="0.5" />
      <path d={male ? 'M 112,97 C 122,93 134,91 142,98' : 'M 109,97 C 119,93 131,91 139,98'} stroke={DETAIL} strokeWidth="1.8" fill="none" opacity="0.5" />
      ...
      <path
        d={male ? 'M 74,52 C 80,64 90,70 100,70 C 110,70 120,64 126,52' : 'M 77,52 C 82,65 91,72 100,72 C 109,72 118,65 123,52'}
        stroke={DETAIL} strokeWidth="1.5" fill="none" opacity="0.35"
      />

      <path d={male ? 'M 84,25 C 87,22 92,22 95,25' : 'M 84,24 C 87,21 93,21 96,24'} stroke={DETAIL} strokeWidth="1.8" fill="none" strokeLinecap="round" opacity="0.55" />
      <path d={male ? 'M 105,25 C 108,22 113,22 116,25' : 'M 104,24 C 107,21 113,21 116,24'} stroke={DETAIL} strokeWidth="1.8" fill="none" strokeLinecap="round" opacity="0.55" />
      ...
      <path
        d={male ? 'M 100,35 L 96,42 C 97,44 100,45 103,44 L 100,42 Z' : 'M 100,35 L 97,42 C 98,44 100,45 102,44 L 100,42 Z'}
        fill={DETAIL} opacity="0.3"
      />

      <path
        d={male ? 'M 92,50 C 96,53 104,53 108,50 M 93,50 C 97,47 103,47 107,50' : 'M 90,51 C 95,55 105,55 110,51 M 91,51 C 95,48 105,48 109,51'}
        stroke={DETAIL} strokeWidth="1.6" fill="none" strokeLinecap="round" opacity="0.5"
      />

      {/* FEMALE HAIR STRANDS — on top */}
      {!male && (
        <>
