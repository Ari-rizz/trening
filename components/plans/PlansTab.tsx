        ...
        {warningDialog && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-black/70 z-[44]"
            ...
            <motion.div
              ...
              className="fixed left-4 right-4 top-1/2 -translate-y-1/2 z-[45] bg-zinc-950 border border-zinc-800 rounded-2xl p-5 max-h-[80vh] overflow-y-auto"
            >
