...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    shortDescription: 'En muskelgruppe per dag — klassisk gym-split',
    description: 'Den klassiske "bro split" — én muskelgruppe per treningsdag for maksimalt volum og fokus. Bryst på mandag, rygg på tirsdag, skuldre på onsdag, armer på torsdag og bein på fredag.',
    level: 'intermediate',
    daysPerWeek: 5,
    durationWeeks: 10,
    tags: ['chest', 'back', 'shoulders', 'biceps', 'triceps', 'legs'],
    accentColor: '#f43f5e',
    days: [
      {
        id: 'bro-chest',
        name: 'Day 1 — Chest',
        exercises: [
          { exerciseName: 'Barbell Bench Press - Medium Grip', sets: 4, reps: 8, restSeconds: 120 },
          { exerciseName: 'Incline Dumbbell Press', sets: 4, reps: 10, restSeconds: 90 },
          { exerciseName: 'Decline Barbell Bench Press', sets: 3, reps: 10, restSeconds: 90 },
          { exerciseName: 'Dumbbell Flyes', sets: 4, reps: 12, restSeconds: 60 },
      ...
      },
      {
        ...
        exercises: [
          { exerciseName: 'Barbell Deadlift', sets: 4, reps: 6, restSeconds: 180 },
          { exerciseName: 'Bent Over Barbell Row', sets: 4, reps: 8, restSeconds: 120 },
          { exerciseName: 'Wide-Grip Lat Pulldown', sets: 4, reps: 10, restSeconds: 90 },
          { exerciseName: 'Seated Cable Rows', sets: 4, reps: 12, restSeconds: 90 },
          { exerciseName: 'Chin-Up', sets: 3, reps: 8, restSeconds: 90 },
        ],
      },
      {
        id: 'bro-shoulders',
        ...
        exercises: [
          { exerciseName: 'Barbell Shoulder Press', sets: 4, reps: 8, restSeconds: 120 },
          { exerciseName: 'Dumbbell Shoulder Press', sets: 4, reps: 10, restSeconds: 90 },
          { exerciseName: 'Side Lateral Raise', sets: 5, reps: 15, restSeconds: 60 },
          { exerciseName: 'Face Pull', sets: 4, reps: 15, restSeconds: 60 },
          { exerciseName: 'Dumbbell Lying Rear Lateral Raise', sets: 4, reps: 15, restSeconds: 60 },
        ],
      },
      {
        ...
        name: 'Day 4 — Arms',
        exercises: [
          { exerciseName: 'Barbell Curl', sets: 4, reps: 10, restSeconds: 90 },
          { exerciseName: 'EZ-Bar Curl', sets: 3, reps: 12, restSeconds: 60 },
          { exerciseName: 'Dumbbell Bicep Curl', sets: 3, reps: 12, restSeconds: 60 },
          { exerciseName: 'Cable Hammer Curls - Rope Attachment', sets: 3, reps: 15, restSeconds: 60 },
          { exerciseName: 'Triceps Pushdown', sets: 4, reps: 12, restSeconds: 60 },
          { exerciseName: 'EZ-Bar Skullcrusher', sets: 3, reps: 12, restSeconds: 60 },
          { exerciseName: 'Dips - Triceps Version', sets: 3, reps: 10, restSeconds: 90 },
          { exerciseName: 'Cable Rope Overhead Triceps Extension', sets: 3, reps: 15, restSeconds: 60 },
        ],
      },
      {
        id: 'bro-legs',
        name: 'Day 5 — Legs',
        exercises: [
          { exerciseName: 'Barbell Squat', sets: 4, reps: 8, restSeconds: 180 },
          { exerciseName: 'Romanian Deadlift', sets: 4, reps: 10, restSeconds: 120 },
          { exerciseName: 'Leg Press', sets: 4, reps: 12, restSeconds: 90 },
          { exerciseName: 'Lying Leg Curls', sets: 4, reps: 12, restSeconds: 60 },
          { exerciseName: 'Barbell Lunge', sets: 3, reps: 12, restSeconds: 90 },
          { exerciseName: 'Standing Calf Raises', sets: 5, reps: 20, restSeconds: 60 },
          { exerciseName: 'Hanging Leg Raise', sets: 3, reps: 15, restSeconds: 60 },
        ],
